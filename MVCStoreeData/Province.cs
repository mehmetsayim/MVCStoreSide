    ...
    public class ProvinceEntityTypeConfiguration : IEntityTypeConfiguration<Province>
    {
        public void Configure(EntityTypeBuilder<Province> builder)
        {
            ...
            builder
                ...
                .IsUnique();// aynı isimde iki tane reyon olamaz "iki tane çoçuk giyim reyonu olamaz"
            builder
              .HasMany(p => p.Cities) // bir ilin birden fazla ilçesi olur 
              .WithOne(p => p.Province)  // bir ilçenin bir tane ili olur    
              .HasForeignKey(p => p.ProvinceId)
              .OnDelete(DeleteBehavior.Cascade); // il silindiğinde ilçeleri otomatik silinir 
            builder
                .HasData(new Province { Id = 1, Name = "Adana" },
